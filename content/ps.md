<main>
    ...
    <section class="basico">
        ...
        <ul>
            <li><alias>PWD</alias> - Mostra onde você está agora, o "mapa".</li>
            <li><alias>LS</alias> ou <alias>DIR</alias> - Lista o conteúdo da pasta atual.</li>
            <li><alias>CD</alias> &lt;nome_da_pasta&gt; - Entra na pasta atual.</li>
            <li><alias>CD</alias> .. - Volta uma pasta para trás.</li>
            <li><alias>CD</alias> ~ - Volta direto para a pasta de usuário, a pasta inicial.</li>
